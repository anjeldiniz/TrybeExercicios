...
const compara = (RIGHT_ANSWERS, STUDENT_ANSWERS) => {
...
const contandoPontos = (RIGHT_ANSWERS, STUDENT_ANSWERS, action) => {
  let contador = 0;
...
console.log(contandoPontos(RIGHT_ANSWERS, STUDENT_ANSWERS, compara));
