...
// const objectsArray = cities.map( (city) => { //{ state: "AM", name: "Manaus" , region: "N" }
//   const findState = states.find( (state) => { // findState = { short: 'AM', name: 'Amazonas' }
//     return state.short === city.state;
//   } );
//   const findRegion = regions.find( (region) => { // findRegion = { short: 'N', name: 'Norte' }
//     return region.short === city.region;
//   } );
//   return {
//       state: findState.short,
//       city: city.name,
